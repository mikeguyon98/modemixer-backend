from ml.data.get_images import return_images_links_by_gender, return_images_links_by_gender_and_date
...
def summaries_by_gender_and_date( gender: str , date: any) -> list[Document]:
    ref_images = return_images_links_by_gender_and_date(date)
    docs = []
    for url in ref_images[gender]:
        try:
            trend_summary = generate_trend_summary(url)
